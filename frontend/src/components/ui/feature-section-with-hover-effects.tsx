...
const Feature = ({
  ...
  return (
    <div
      className={cn(
        "flex flex-col lg:border-r py-8 md:py-10 relative group dark:border-neutral-800 cursor-pointer",
    ...
    >
      ...
      <div className="mb-4 relative z-10 px-6 md:px-10 text-neutral-600 dark:text-neutral-400 group-hover:text-primary transition-colors duration-300">
        {icon}
      </div>
